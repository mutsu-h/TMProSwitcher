...
[TrackClipType(typeof(TMProSwitcherClip))]
[TrackBindingType(typeof(TextMeshProUGUI))]
public class TMProSwitcherTrack : TrackAsset
{
    public override Playable CreateTrackMixer(PlayableGraph graph, GameObject go, int inputCount)
    {
        return ScriptPlayable<TMProSwitcherMixerBehaviour>.Create (graph, inputCount);
    }
