...
public class TMProSwitcherMixerBehaviour : PlayableBehaviour
{
    ...
    public override void ProcessFrame(Playable playable, FrameData info, object playerData)
    {
        ...
        for (int i = 0; i < inputCount; i++)
        {
            ...
            ScriptPlayable<TMProSwitcherBehaviour> inputPlayable = (ScriptPlayable<TMProSwitcherBehaviour>)playable.GetInput(i);
            TMProSwitcherBehaviour input = inputPlayable.GetBehaviour ();
